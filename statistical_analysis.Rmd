...
# Figure S6 a,b - Frequency of NT formation in $\Delta sigD$ {#figS6}
...
if(redo_plots) {
  ...
  plot6b <- plot_cell_count_data_NTs(data_S6ab, facet_wrap(~alive_string)) + expand_limits(y = 0.1)
  plot6a + plot6b
}
```
...
# Figure S6 d,e - Frequency of NT formation in $\Delta lytEF$
...
if(redo_plots) {
  ...
  figS6e <- plot_cell_count_data_NTs(data_S6de, facet_wrap(~alive_string)) 
  figS6d + figS6e
}
```
